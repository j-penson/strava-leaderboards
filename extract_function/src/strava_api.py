...
def get_strava_data(activity_type, sw_lat, sw_lon, ne_lat, ne_lon):
    ...
    filename = get_filename(activity_type, coordinates, grid=False)

    segments = client.explore_segments(bounds=coordinates, activity_type=activity_type)
